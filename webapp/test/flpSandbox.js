		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Picking Application",
									"targetURL": "#zfcwmzwmpicking-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zfcwmzwmpicking-display": {
								"semanticObject": "zfcwmzwmpicking",
								"action": "display",
								"description": "Picking Application.",
								"title": "Picking Application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zfc.wm.zwmpicking",
									"url": sap.ui.require.toUrl("zfc/wm/zwmpicking")
								}
							}
						}
					}
